def processar_substituicoes(novo):
    substituicoes = {
        "oneight": "18", "twone": "21", "fiveeight": "58", "nineight": "98",
        "sevenine": "79", "eightwo": "82", "eighthree": "83",
        "one": "1", "two": "2", "three": "3", "four": "4",
        "five": "5", "six": "6", "seven": "7", "eight": "8", "nine": "9"
    }

    for palavra, substituicao in substituicoes.items():
        novo = novo.replace(palavra, substituicao)

    return novo

def extrair_primeiro_e_ultimo_digito(palavra):
    primeiro_digito = ""
    segundo_digito = ""
...
def main():
    ...
    for i in range(len(calibradores)):
        novo = calibradores[i]
        novo = processar_substituicoes(novo)
        primeiro_digito, segundo_digito = extrair_primeiro_e_ultimo_digito(novo)
        if primeiro_digito and segundo_digito:
            con = primeiro_digito + segundo_digito
            soma_total += int(con)
            print(con)
